"""
This script identifies clouds in the cloud composite dataset. It uses one of the masks
from the original dataset to identify clouds. This mask can be selected by setting the
variable ``mask_name``. All np.nan values in the rain_mask are set to 0/False.
